...
**Status:** herzien voorstel ter beoordeling — geen applicatiecode gewijzigd, geen Git-actie uitgevoerd
...
**Correctie verwerkt:** Hoofdtaken blijft een zelfstandig navigatie-item. In de vorige versie van dit voorstel liet ik "Hoofdtaken" vervallen omdat "Alles" al hoofdtaken toont; Peter heeft dit teruggedraaid. Reden om dit nu te volgen: "Alles" en "Hoofdtaken" zijn niet noodzakelijk identiek zodra subtaken via andere filters (Vandaag, Week, Wachten) ook los zichtbaar kunnen worden — "Hoofdtaken" is dan de expliciete garantie dat je uitsluitend op het hoofdtaakniveau zit, ongeacht wat andere filters tonen. Dat is een zelfstandige, herkenbare vraag en verdient een eigen ingang.
...
Twee visuele groepen (dun scheidingslijntje, geen kader): **taakfilters op tijd/omvang** boven (Vandaag, Week, Alles, Hoofdtaken), **kanalen en status** eronder (Afspraken, E-mail, Wachten, Afgerond). Geen "Instellingen" hier — dat hoort niet in dit scherm-ontwerp en staat al in de hoofdnavigatie per `DESIGN_SYSTEM.md` §4.
...
## 2. Navigatiebadges — voorstel, nog niet goedgekeurd

**Correctie verwerkt:** de vorige versie van dit document meldde dat Peter de badges al had goedgekeurd. Dat was onjuist en is hier verwijderd — de badges zijn een **visueel voorstel**, net als de rest van dit document, en wachten op dezelfde goedkeuring.

Voorgestelde regels, indien Peter de badges accepteert:

- alleen het **aantal hoofdtaken met rood deadlinegevaar** wordt geteld;
- **oranje risico telt niet mee** in de badge;
- **geen badge wanneer het aantal nul is** — geen zichtbare "0";
- de badge is uitsluitend **een klein rood getal** naast het navigatielabel — **geen rood achtergrondvlak**, geen gekleurde balk over de regel.

Toepassing: bij "Vandaag" en "Hoofdtaken" (niet bij "Alles" — met Hoofdtaken terug als apart item is dat de meest precieze plek voor een risicoteller op hoofdtaakniveau; "Alles" kan immers ook subtaken/afspraken-achtige items bevatten afhankelijk van later filtergedrag). "E-mail" kan een neutrale, niet-rode teller krijgen voor openstaande voorstellen — dat is geen deadlinerisico en gebruikt dus nooit de rode badge-stijl.

Dit blijft optioneel ten opzichte van de rest van het ontwerp: als Peter de badges afwijst, verandert er niets aan zones, kolommen of wireframes elders in dit document.
...
4. **Risico-indicator** — één kleine stip/staafje in groen/oranje/rood, **geen tekstlabel in de rij zelf**. Kleur is nooit de enige drager: bij oranje/rood krijgt de stip een subtiele vorm-variant (bijv. gevulde stip vs. ring) zodat kleurenblindheid de rij nog steeds laat onderscheiden.

Wat expliciet **niet** in de rij staat: omschrijving, tijdsinschatting-detail, afhankelijkheden, bijlagen, logboek.

Subtaken zijn geen aparte rijen in deze middenlijst — die verschijnen pas in het detailpaneel rechts (zie §5). De middenlijst binnen "Hoofdtaken" en "Alles" toont uitsluitend hoofdtaken.
...
**Correctie verwerkt:** O21 is door Peter inhoudelijk goedgekeurd. Dit is geen open voorstel meer binnen dit ontwerpdocument — het ontwerp moet dit gedrag correct tonen. Vastlegging in `docs/DECISIONS.md` gebeurt apart van dit visuele document, maar dit ontwerp gaat er vanaf nu vanuit dat de regels gelden:
...
Optioneel een vierde plek — **navigatiebadge** (§2) — indien Peter dat voorstel goedkeurt.

Rood wordt nooit gebruikt als achtergrondvlak van een rij of paneel — alleen als stip, randlijn, tekstlabel of (bij de badge) klein cijfer.
...
│ Week           │ ──────────────────────────────────   │ Wachten                              │
│ Alles          │▶Truckparking Duiven vo…      (sel.)  │ Deadline: vr 24 jul, 17:00            │
│ Hoofdtaken 2   │  Wachten            vr 24jul  3u40m ◐│                                       │
│ ────────────   │ ──────────────────────────────────   │ ⚠ Kleine marge — gekozen duur ligt    │
│ Afspraken      │ Administratie 2e kwartaal              │   30 min onder persoonlijk advies.    │
│ E-mail     3   │  1 subtaak            —      1u15m    │                                       │
...
`2` naast "Hoofdtaken" = optionele risicobadge (§2), alleen tellend hoofdtaken met rood risico, geen badge bij nul. `◐` = risicostip (gevulde halve vorm voor oranje, volle stip voor rood, open ring voor groen).
...
│ Week           │ ──────────────────────────────────│                               │
│ Alles          │ 09:00–09:30  Dagstart               │ 14:00–14:30                  │
│ Hoofdtaken 2   │ 14:00–14:30  Overleg Erwin (sel.)   │ Locatie: Teams               │
│ ────────────   │ ──────────────────────────────────│ 2 deelnemers                 │
│ Afspraken (sel)│ Morgen, 19 juli                     │                               │
│ E-mail     3   │ 10:00–11:00  TP Duiven bezoek        │ Alleen-lezen via Outlook.    │
│ ────────────   │                                       │                               │
│ Wachten        │                                       │                               │
│ Afgerond       │                                       │                               │
└────────────────┴───────────────────────────────────────┴───────────────────────────────┘
...
│ Alles          │ Offerte laadpalen…      (sel.)      │                                    │
│ Hoofdtaken 2   │  taak · hoge betrouwbaarheid         │ Samenvatting: levertijd 6 weken,  │
...
│ Week             │ ─────► │                  │ ─────► │                  │
│ Alles            │        │ Truckparking...  │        │ Truckparking...  │
│ Hoofdtaken     2 │        │ vr 24jul  3u40m ◐│        │ Wachten          │
│ ─────────────    │        │                  │        │ ⚠ Kleine marge…  │
│ Afspraken        │        │ Administratie... │        │ [+ Subtaak]      │
│ E-mail         3 │        │ —          1u15m │        │ Subtaken (4)     │
│ ─────────────    │        │                  │        │  ...             │
│ Wachten          │        │                  │        │                  │
│ Afgerond         │        │                  │        │                  │
└─────────────────┘        └─────────────────┘        └─────────────────┘
...
- de linkernavigatie exact zoals in §1: Vandaag, Week, Alles, Hoofdtaken, Afspraken, E-mail, Wachten, Afgerond, in de twee groepen, zonder WhatsApp;
...
- de navigatiebadges uit §2 — dit blijft een apart voorstel; wordt pas gebouwd na Peters expliciete keuze hierover, los van de rest;
...
*Er is in dit document geen applicatiecode gewijzigd en geen Git-actie uitgevoerd. Dit is uitsluitend een herzien ontwerpvoorstel ter beoordeling.*
